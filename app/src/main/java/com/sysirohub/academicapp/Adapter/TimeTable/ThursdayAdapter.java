...
public class ThursdayAdapter extends RecyclerView.Adapter<ThursdayAdapter.MyViewHolder> {
    ...
    Context context;
    List<Thursday> mondayList;
    RecyclerViewClickInterface recyclerViewClickInterface;

    public ThursdayAdapter(Context context, List<Thursday> mondayList,RecyclerViewClickInterface recyclerViewClickInterface) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        Thursday monday = mondayList.get(position);
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            tv1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    recyclerViewClickInterface.onItemClick(getAdapterPosition(),"THURSDAY");
