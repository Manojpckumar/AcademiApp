...
public class FridayAdapter extends RecyclerView.Adapter<FridayAdapter.MyViewHolder> {

    Context context;
    List<Friday> mondayList;
    RecyclerViewClickInterface recyclerViewClickInterface;

    public FridayAdapter(Context context, List<Friday> mondayList,RecyclerViewClickInterface recyclerViewClickInterface) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        Friday monday = mondayList.get(position);
        ...
        public MyViewHolder(@NonNull View itemView) {
            ...
            tv1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    recyclerViewClickInterface.onItemClick(getAdapterPosition(),"FRIDAY");
